...
```bash
REQS=.github/requirements/kb-dashboard.requirements.txt
...
The pinned package hashes live in `.github/requirements/kb-dashboard.requirements.txt`. Keep this file updated when bumping compiler versions.
...
uvx --with-requirements .github/requirements/kb-dashboard.requirements.txt --from kb-dashboard-cli==0.4.0 kb-dashboard docs llms-full

# Copy to clipboard (macOS)
uvx --with-requirements .github/requirements/kb-dashboard.requirements.txt --from kb-dashboard-cli==0.4.0 kb-dashboard docs llms-full | pbcopy

# List available workflow guides
uvx --with-requirements .github/requirements/kb-dashboard.requirements.txt --from kb-dashboard-cli==0.4.0 kb-dashboard docs list-guides

# Output a specific guide
uvx --with-requirements .github/requirements/kb-dashboard.requirements.txt --from kb-dashboard-cli==0.4.0 kb-dashboard docs guide dashboard-style-guide
```
...
1. **Lint it** to catch schema issues:
   ...
   ```bash
   uvx --with-requirements .github/requirements/kb-dashboard.requirements.txt --from kb-dashboard-lint==0.4.0 kb-dashboard-lint check --input-file dashboard.yaml
   ```

2. **Compile it** to verify it produces valid integration JSON:

   ```bash
   uvx --with-requirements .github/requirements/kb-dashboard.requirements.txt --from kb-dashboard-cli==0.4.0 kb-dashboard compile \
